...
def main():
    ...
    if bidirectional == "True":
        tr_log_file_name = "bidanse_training.log"
        te_log_file_name = "bidanse_testing.log"
    else:
        tr_log_file_name = "danse_training.log"
        te_log_file_name = "danse_testing.log"
    ...
    if mode.lower() == "train":
        ...
        if bidirectional == 'True':
            with open(os.path.join(os.path.join(logfile_path, main_exp_name),
                'bi_danse_{}_losses_eps{}.json'.format(estimator_options['rnn_type'],
